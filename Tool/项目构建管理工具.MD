...
| 目录      | 说明                                 |
| -------------------- | ------------------------------------------------------------ |
| `src/main/java`      | Application/Library sources<br/>源码                  |
| `src/main/resources` | Application/Library resources<br/>资源                  |
| `src/main/filters`   | Resource filter files<br/>资源过滤                               |
| `src/main/webapp`    | Web application sources<br/>Web应用程序源码                        |
| `src/test/java`      | Test sources<br/>测试源码                                      |
| `src/test/resources` | Test resources<br/>测试资源                                      |
| `src/test/filters`   | Test resource filter files<br/>测试资源过滤                        |
| `src/it`             | Integration Tests (primarily for plugins)<br/>集成测试           |
| `src/assembly`       | Assembly descriptors<br/>程序集描述符                              |
| `src/site`           | Site<br/>站点                                                  |
| `LICENSE.txt`        | Project's license<br/>授权、许可                              |
| `NOTICE.txt`         | Notices and attributions required by libraries that the project depends on<br/>库依赖 |
| `README.txt`         | Project's readme<br/>读我                                      |
